...
<div class="container mx-auto px-4 pt-16">
    <div class="latest-business-news">
        <h2 class="uppercase tracking-wider text-white-500 text-lg font-semibold">{{$keyword}}の検索結果</h2>
        ...
        @if ($bz_news)
            ...
            @endforeach
        @else
        <h3 class="tracking-wider text-white-500 text-lg font-semibold mt-6 w-max">キーワードに一致する情報は見つかりませんでした。</h3>
        <a href="/" class="w-max bg-purple-500 text-gray-900 rounded font-semibold mt-6 ml-20 px-3 py-1 hover:bg-purple-600 transition ease-in-out 
        duration-150 cursor-pointer">戻る</a>
        @endif
        </div>
    </div>
</div>
